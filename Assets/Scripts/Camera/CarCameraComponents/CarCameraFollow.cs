...
public class CarCameraFollow : CarCameraComponent
{
    ...
    [SerializeField] private float heightDampind;
    ...
    private void FixedUpdate()
    {
        ...
        float currentHeight = Mathf.Lerp(transform.position.y, target.position.y + height, heightDampind * Time.fixedDeltaTime);
