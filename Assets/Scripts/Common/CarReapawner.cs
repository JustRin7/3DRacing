...
public class CarReapawner : MonoBehaviour, IDependency<RaceStateTracker>, IDependency<Car>, IDependency<CarInputControl>
{
    ...
    private void Start()
    {
        raceStateTracker.TrackPointPasstd += OnTrackPointPassed;
    }
